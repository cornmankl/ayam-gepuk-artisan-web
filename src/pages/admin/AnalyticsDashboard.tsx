    ...
    const fetchAnalytics = async () => {
        ...
        try {
            ...
            const mockAnalytics: AnalyticsData = {
                ...
                revenue: {
                    daily: [
                        { date: '2023-10-14', revenue: 1250.00 },
                        { date: '2023-10-15', revenue: 1380.50 },
                        { date: '2023-10-16', revenue: 1120.75 },
                        { date: '2023-10-17', revenue: 1450.25 },
                        { date: '2023-10-18', revenue: 1620.00 },
                        { date: '2023-10-19', revenue: 1780.50 },
                    ...
                    byOutlet: [
                        { outlet: 'Seremban Main', revenue: 25680.50 },
                        { outlet: 'KL Branch', revenue: 20000.00 }
                    ]
                },
                orders: {
                    daily: [
                ...
                menu: {
                    topSelling: [
                        { item: 'Ayam Gepuk Krispy', quantity: 245, revenue: 3675.00 },
                        { item: 'Ayam Gepuk Klasik', quantity: 198, revenue: 2950.20 },
                        { item: 'Nasi Lemak Special', quantity: 156, revenue: 1872.00 },
                        { item: 'Ayam Gepuk Extra Spicy', quantity: 134, revenue: 2010.00 },
                        { item: 'Chicken Wings', quantity: 98, revenue: 1470.00 }
                    ],
                    categories: [
                        { category: 'Ayam Krispy', orders: 456, revenue: 6840.00 },
                        { category: 'Ayam Klasik', orders: 389, revenue: 5801.10 },
                        { category: 'Side Dishes', orders: 234, revenue: 1170.00 },
                        { category: 'Drinks', orders: 567, revenue: 1134.00 }
                    ],
                    ratings: [
        ...
        return (
            <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center">
                ...
                >
                    ...
                    <p className="text-brand-black dark:text-white font-heading">Loading Analytics...</p>
                </motion.div>
            </div>
        );
    }
                            ...
                            <div className="flex gap-2">
                                {periods.map((period) => (
                                    <button
                                        ...
                                        className={`px-4 py-2 rounded-xl font-heading font-semibold transition-all duration-300 ${selectedPeriod === period.id
                            ...
                            <div className="flex gap-2">
                                {metrics.map((metric) => (
                                    <button
                                        ...
                                        className={`px-4 py-2 rounded-xl font-heading font-semibold transition-all duration-300 ${selectedMetric === metric.id
                    ...
                    {overviewCards.map((card, index) => (
                        ...
                        >
                            <div className="flex items-center justify-between mb-4">
                                ...
                                <span className={`text-sm font-heading font-semibold ${card.change >= 0 ? 'text-green-600' : 'text-red-600'
                                    }`}>
                    ...
                    >
                        ...
                        <div className="space-y-3">
                            {analytics?.orders.byStatus.map((status, index) => (
                                ...
                                >
                                    <div className="flex items-center gap-3">
                                        <div className={`w-4 h-4 rounded-full ${status.status === 'Delivered' ? 'bg-green-500' :
