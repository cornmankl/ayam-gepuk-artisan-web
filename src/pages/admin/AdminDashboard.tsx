    ...
    const fetchDashboardData = async () => {
      ...
      try {
        ...
        const mockStats: DashboardStats = {
          ...
          newCustomersToday: 8,
          topSellingItems: [
            { id: 1, name: 'Ayam Gepuk Krispy', quantity: 45, revenue: 1350.0 },
            { id: 2, name: 'Ayam Gepuk Klasik', quantity: 38, revenue: 1140.0 },
            { id: 3, name: 'Nasi Lemak Special', quantity: 32, revenue: 960.0 },
          ],
          recentOrders: [
            {
              id: 1001,
            ...
            {quickActions.map((action, index) => {
              ...
              return (
                ...
                >
                  <action.icon
                    size={32}
                    className="text-brand-red mx-auto mb-3 group-hover:scale-110 transition-transform duration-300"
                  />
