            ...
            const mockItems: MenuItem[] = [
                {
                    ...
                    price: 15.90,
                    category: 'krispy',
                    image: 'https://uploadthingy.s3.us-west-1.amazonaws.com/p5irPgQNgTn2ETzne3anjp/ayam-krispy.jpg',
                    popular: true,
                    available: true,
                ...
                },
                {
                    ...
                    price: 14.90,
                    category: 'klasik',
                    image: 'https://uploadthingy.s3.us-west-1.amazonaws.com/p5irPgQNgTn2ETzne3anjp/ayam-klasik.jpg',
                    popular: true,
                    available: true,
                                ...
                                <div className="h-48 overflow-hidden relative">
                                    ...
                                    <div className="absolute top-4 right-4 flex gap-2">
                                        ...
                                        <button
                                            ...
                                            className={`p-2 rounded-full transition-all duration-300 ${item.available
