...
import { PlusIcon, MinusIcon, ShoppingCartIcon, SearchIcon, FilterIcon, StarIcon } from 'lucide-react';
...
const MenuPage = () => {
  ...
  return <div className="bg-gray-50 min-h-screen py-8 px-4 font-body">
                ...
                >
                      ...
                      <div className="flex justify-between items-start mb-3">
                        <div className="flex-1">
                          ...
                          {item.popular && (
                            ...
                            >
                              <StarIcon size={16} className="text-yellow-gold fill-current" />
                              <span className="text-sm font-body font-medium text-yellow-gold">Popular</span>
                            </motion.div>
                          )}
                        </div>
                        <motion.span
                  ...
                  >
                    ...
                    <motion.button 
                      ...
                      disabled={!quantities[item.id]}
                      whileHover={quantities[item.id] ? { scale: 1.05, y: -2 } : {}}
