...
export const faqData: FAQItem[] = [
  {
    ...
    answer:
      "Ayam Gepuk is a traditional Indonesian dish of smashed fried chicken. The chicken is marinated with special spices, then smashed to make it tender and crispy, and served with spicy sambal. It's a popular street food in Indonesia and now available in Malaysia!",
    category: 'general',
    keywords: [
      'ayam gepuk',
      'what is',
  ...
  },
  {
    ...
    answer:
      "Yes! All our food is 100% halal certified. We use only halal ingredients and follow strict halal preparation methods. Our certification is verified and we're proud to serve the Muslim community with authentic, halal Indonesian cuisine.",
    category: 'general',
  ...
  },
  {
    ...
    answer:
      "We are open Monday to Sunday from 10:00 AM to 10:00 PM. We're available every day for lunch, dinner, and late-night cravings!",
    category: 'hours',
...
export const menuData: MenuItem[] = [
  {
    ...
    description:
      'Crispy smashed fried chicken with spicy sambal and traditional Indonesian spices',
    price: 15.9,
    category: 'krispy',
    ingredients: [
      'Chicken',
  ...
  },
  {
    ...
    description:
      'Traditional smashed fried chicken with mild spices and authentic Indonesian flavor',
    price: 14.9,
    category: 'klasik',
    ingredients: [
      'Chicken',
  ...
  },
  {
    ...
    description:
      'Fragrant coconut rice served with traditional sides and sambal',
    price: 12.0,
    category: 'side',
    ingredients: [
      'Coconut Rice',
...
export const promotionData: Promotion[] = [
  {
    ...
    description:
      'Enjoy our special family bundle with 2 Ayam Gepuk Klasik, 2 Ayam Gepuk Krispy, 4 rice, and 4 drinks!',
    discountType: 'combo',
    discountValue: 20,
  ...
  },
  {
    ...
    title: 'Combo Jimat',
    description:
      'Save more with our Combo Jimat! Choose any Ayam Gepuk with a drink for only RM15.',
    discountType: 'fixed',
    discountValue: 5,
    validFrom: '2023-09-01',
    validUntil: '2023-11-30',
    terms: [
      'Any Ayam Gepuk + Drink',
      'Valid for all items',
      'Cannot combine with other offers',
    ],
    applicableItems: ['ayam-gepuk-krispy', 'ayam-gepuk-klasik'],
