      ...
      const resourceObserver = new PerformanceObserver(list => {
        ...
        entries.forEach((entry: PerformanceEntry) => {
          ...
          const isFailedConnection =
            resourceEntry.transferSize === 0 && resourceEntry.duration > 1000;
          const isDevServerPolling =
            resourceEntry.name.includes('localhost:5175') &&
            resourceEntry.transferSize === 0;
          const isConnectionRefused = resourceEntry.name.includes(
