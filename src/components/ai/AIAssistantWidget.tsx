...
const AIAssistantWidget: React.FC = () => {
    ...
    const addMessage = (type: 'user' | 'ai', content: string, isTyping = false) => {
                    ...
                    {messages.map((message) => (
                        ...
                        >
                            ...
                            <div className={`max-w-[80%] ${message.type === 'user' ? 'order-first' : ''}`}>
                                ...
                                <div className={`text-xs text-brand-black/50 dark:text-gray-400 mt-1 ${message.type === 'user' ? 'text-right' : 'text-left'
                                    }`}>
                    ...
                    {isTyping && (
                        ...
                        >
                            ...
                            <div className="bg-gray-100 dark:bg-gray-700 px-4 py-3 rounded-2xl">
                                <div className="flex items-center gap-2">
                                    <LoaderIcon size={16} className="animate-spin text-brand-red" />
                                    <span className="text-sm text-brand-black dark:text-white">AI is typing...</span>
                                </div>
                            </div>
                        </motion.div>
                    )}
