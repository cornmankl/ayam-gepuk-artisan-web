  ...
  const features = [
    {
      ...
      description: "Our recipes are crafted with traditional Indonesian spices and cooking techniques, passed down through generations for an authentic taste experience."
    },
    {
      icon: "M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z",
      title: "Quick Service",
      description: "Fast preparation and delivery ensuring your food arrives hot and fresh, just as it should be. We value your time as much as we value quality."
    },
    {
      icon: "M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z",
      title: "Premium Ingredients",
      description: "We source only the highest quality ingredients, ensuring every dish meets our strict standards and delivers exceptional flavor in every bite."
    }
  ];
