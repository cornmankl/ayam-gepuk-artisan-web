...
import { ShoppingBagIcon, PhoneIcon, StarIcon, TruckIcon, UtensilsIcon, AwardIcon } from 'lucide-react';
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <ShoppingBagIcon size={20} className="mr-2 md:mr-3 group-hover:scale-110 transition-transform duration-300" />
                  Order Now
                </Link>
              </motion.div>
              ...
              >
                ...
                >
                  <PhoneIcon size={20} className="mr-2 md:mr-3 group-hover:scale-110 transition-transform duration-300" />
                  Call Us
                </a>
              </motion.div>
            </motion.div>
            ...
            >
              {[
                { icon: StarIcon, text: "4.9 Rating", color: "text-yellow-gold", bgColor: "bg-yellow-gold/20" },
                { icon: TruckIcon, text: "Fast Delivery", color: "text-brand-red", bgColor: "bg-brand-red/20" },
                { icon: UtensilsIcon, text: "Authentic Taste", color: "text-brand-red", bgColor: "bg-brand-red/20" }
              ].map((badge, index) => (
                <motion.div
                  key={index}
                ...
                >
                  ...
                  <span className="text-brand-black font-heading font-semibold text-sm md:text-base">{badge.text}</span>
                </motion.div>
              ))}
            </motion.div>
          </motion.div>
