...
const SEOHead: React.FC<SEOHeadProps> = ({
  ...
  const fullTitle = title.includes('Ayam Gepuk Artisan')
    ? title
    : `${title} | Ayam Gepuk Artisan`;
  const fullUrl = url.startsWith('http')
    ? url
    : `https://ayamgepukartisan.com${url}`;
  ...
  const defaultStructuredData = {
    ...
    description:
      'Authentic Indonesian smashed fried chicken with traditional spices and sambal',
    url: 'https://ayamgepukartisan.com',
  ...
  return (
    <Helmet>
      ...
      <link
        rel="icon"
        type="image/jpeg"
        href="/ayamgepukartisanseremban2_%281%29.jpg"
      />
      <link
      ...
      <link
        rel="preconnect"
        href="https://uploadthingy.s3.us-west-1.amazonaws.com"
      />
      ...
      <script type="application/ld+json">
        {JSON.stringify({
          ...
          potentialAction: {
            '@type': 'SearchAction',
            target:
              'https://ayamgepukartisan.com/menu?search={search_term_string}',
