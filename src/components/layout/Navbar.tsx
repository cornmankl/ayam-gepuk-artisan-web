        ...
        <div className="flex justify-between items-center">
          <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
            <Link to="/" className="flex items-center space-x-3 group">
              ...
              >
                <LogoIcon size={64} variant="full" className="drop-shadow-lg" />
              </motion.div>
            </Link>
          </motion.div>
          {/* Desktop Navigation */}
          <nav className="hidden md:flex items-center space-x-10">
            ...
            >
              <Link
                to="/cart"
                className="relative text-brand-black hover:text-brand-red bg-white/20 p-3 rounded-xl hover:bg-white/30 transition-all duration-300"
                aria-label="Cart"
              >
                <motion.div
          ...
          <div className="md:hidden flex items-center">
            ...
            >
              <Link
                to="/cart"
                className="relative mr-6 text-brand-black bg-white/20 p-3 rounded-xl"
              >
                <motion.div
                  whileHover={{ scale: 1.1, y: -2 }}
                  whileTap={{ scale: 0.95 }}
