                        ...
                        <div>
                            ...
                            <div className="mb-6">
                                <p className="text-brand-black/80 dark:text-gray-300 font-body leading-relaxed mb-4">
                                    At Ayam Gepuk Artisan, we respect your privacy and are committed to protecting your personal data.
                                ...
                                <p className="text-brand-black/80 dark:text-gray-300 font-body leading-relaxed">
                                    ...
                                    or learn more about our privacy practices.
                                </p>
                            </div>
                            ...
                            <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-600">
                                <p className="text-sm text-brand-black/60 dark:text-gray-400 font-body text-center">
                                    ...
                                    and{' '}
                                    <a href="/terms-of-service" className="text-brand-red hover:underline">
                                        Terms of Service
                                    </a>
                                    .
                                </p>
                        ...
                        <div>
                            ...
                            <div className="space-y-4 mb-6">
                                {cookieTypes.map((type) => (
                                    <motion.div
                                        key={type.key}
                                        className={`p-4 rounded-xl border-2 transition-all duration-300 ${preferences[type.key]
                                    ...
                                    >
                                        <div className="flex items-start gap-4">
                                            <div className={`p-3 rounded-xl ${type.bgColor} flex-shrink-0`}>
