    ...
    return (
      <div className={`flex items-center justify-center ${className}`}>
        ...
        >
          ...
          {/* Black Head Area */}
          <path
            d="M 35 25 Q 50 20 65 25 Q 65 35 50 40 Q 35 35 35 25 Z"
            fill="#1C1C1C"
          />

          {/* Red Comb */}
          <path
            d="M 45 20 Q 50 15 55 20 Q 52 25 50 23 Q 48 25 45 20 Z"
            fill="#E63946"
          />
          ...
          {/* Red Bandana */}
          <path
            d="M 30 45 Q 50 40 70 45 Q 70 50 50 48 Q 30 50 30 45 Z"
            fill="#E63946"
          />
  ...
  if (variant === 'text') {
    return (
      <div className={`flex flex-col items-center ${className}`}>
        <div
          className="text-yellow-400 font-bold text-2xl drop-shadow-lg"
        ...
        <div
          className="text-black text-sm font-handwriting"
          style={{ fontSize: textSize * 0.4 }}
        >
