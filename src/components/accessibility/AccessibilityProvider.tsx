...
export const AccessibilityProvider: React.FC<AccessibilityProviderProps> = ({ children }) => {
    ...
    useEffect(() => {
        ...
        const hasAccessibilityFeatures = Object.values(settings).some(value =>
            value === true || (typeof value === 'string' && value !== 'none' && value !== 'medium' && value !== 'normal')
        );
    ...
    return (
        <>
            ...
            <motion.button
                ...
                className={`fixed bottom-4 right-4 w-14 h-14 rounded-full flex items-center justify-center shadow-brand-lg z-40 transition-all duration-300 ${isAccessibilityMode
