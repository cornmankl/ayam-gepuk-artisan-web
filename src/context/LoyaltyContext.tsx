...
interface LoyaltyContextType {
    ...
    isLoading: boolean;
    earnPoints: (orderId: string, amount: number, description: string) => Promise<void>;
...
const loyaltyTiers: LoyaltyTier[] = [
    ...
    },
    {
        ...
        minPoints: 1000,
        maxPoints: 1999,
        benefits: ['3x points on orders', 'Free side dish', 'Exclusive menu access', 'Free delivery'],
    ...
    },
    {
        ...
        minPoints: 2000,
        maxPoints: Infinity,
        benefits: ['5x points on orders', 'Free meal monthly', 'VIP events', 'Personal chef consultation'],
...
export const LoyaltyProvider: React.FC<LoyaltyProviderProps> = ({ children }) => {
            ...
            const mockRewards: LoyaltyReward[] = [
                {
                    ...
                    pointsRequired: 100,
                    image: 'https://uploadthingy.s3.us-west-1.amazonaws.com/p5irPgQNgTn2ETzne3anjp/free-drink.jpg',
                    category: 'freebie',
                    isActive: true,
                    stock: 50
                },
                {
                    ...
                    pointsRequired: 200,
                    image: 'https://uploadthingy.s3.us-west-1.amazonaws.com/p5irPgQNgTn2ETzne3anjp/discount.jpg',
                    category: 'discount',
                    isActive: true
                },
                {
                    ...
                    pointsRequired: 150,
                    image: 'https://uploadthingy.s3.us-west-1.amazonaws.com/p5irPgQNgTn2ETzne3anjp/free-side.jpg',
                    category: 'food',
                    isActive: true,
                    stock: 25
                },
                {
                    ...
                    pointsRequired: 500,
                    image: 'https://uploadthingy.s3.us-west-1.amazonaws.com/p5irPgQNgTn2ETzne3anjp/vip-meal.jpg',
                    category: 'food',
                    isActive: true,
                    maxRedemptions: 5
                }
    ...
    const earnPoints = async (orderId: string, amount: number, description: string) => {
        try {
